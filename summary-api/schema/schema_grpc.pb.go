...
const (
	SummaryService_Summary_FullMethodName = "/schema.SummaryService/Summary"
)
...
func (c *summaryServiceClient) Summary(ctx context.Context, in *SummaryRequest, opts ...grpc.CallOption) (*SummaryResponse, error) {
	...
	err := c.cc.Invoke(ctx, SummaryService_Summary_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var SummaryService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "schema.SummaryService",
